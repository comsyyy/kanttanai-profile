...
export default function Webfilepage() {
      ...
      <Parallax ref={parallax} pages={3}>
        ...
        <ParallaxLayer
          ...
          style={{
            ...
            backgroundColor: '	#330066', // กำหนดสีพื้นหลังที่คุณต้องการ
          }}
        />
        ...
        <ParallaxLayer
          ...
          <h1>เว็ปแนบไฟล์vpm</h1>
          <p>โปรเจคนี้เป็นโปรเจคของมหาลัยและทําต้นแบบให้กับโรงพยาบาลแห่งหนึ่ง</p>
          <p>*จุดประสงค์เพื่อลดการทํางานที่ยุ่งยากให้กับพนักงาน*</p>
          <div style={{
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
